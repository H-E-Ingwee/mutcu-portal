...
VALUES
  ...
  -- 1ST VICE CHAIR — LADIES FELLOWSHIP WELFARE
  ...
  -- CREATIVE ARTS — FILM PRODUCTION & EVENTS
  ('2024/2025', 'Creative Arts Ministry', 'Events', 13400,
   'Creative docket: manilla papers 9@30 (270), mark pens 3@300 (900 — note: listed as 300 in doc), banner (2000), dance training appreciation (1000), tea (140), creative experience decoration x2 (1500), film production appreciation (5000), food for 5 days — breakfast (bread 130, milk 75, eggs 75 = 280/day x5 = 1400), supper 3 days (rice 120, ndengu 60, cabbage 20, potatoes 50 = 250/day x3 = 750), supper 2 days (maize flour 100, kales 75, eggs 400, meat, onions 240, tomatoes 120, total 1040)',
   NOW()),

  -- CREATIVE ARTS — AIRTIME
